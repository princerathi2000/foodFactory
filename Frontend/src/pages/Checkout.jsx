...
import { toggleBanner } from "../features/banner/bannerSlice";
import { useNavigate } from "react-router-dom";

export function Checkout() {
  let navigate = useNavigate();
  const cartArr = useSelector((state) => state.cartArr?.value);
  const showBanner = useSelector((state) => state.banner?.value);
          ...
          <div className="bg-gray-100 px-5 py-6 md:px-8">
            ...
            <ul className="mt-6 space-y-3">
              <li className="flex items-center justify-between text-gray-600">
                ...
                <p className="text-sm font-medium">$ {amountObj.totalPrice}</p>
              </li>
              <li className="flex items-center justify-between text-gray-600">
              ...
              <li className="flex items-center justify-between text-gray-900">
                ...
                <p className="text-sm font-bold ">$ {amountObj.totalPrice}</p>
              </li>
            </ul>
          </div>
        </div>
