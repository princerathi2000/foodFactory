...
export function Footer() {
  return (
    ...
    //             <a
    //               href="https://www.facebook.com/himanshusharma.loveh"
    //               target="_blank"
    //             >
    ...
    //           </div>
    //           <div className="w-auto p-1.5">
    //             <a href="https://twitter.com/Himansh72232162" target="_blank">
    //               <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
    //                 <svg
    //                   width="14"
    //                   height="11"
    ...
    //           <div className="w-auto p-1.5">
    //             <a
    //               href="https://www.instagram.com/himanshusharma.live/?next=%2F"
    //               target="_blank"
    //             >
    //               <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
    //                 <svg
    ...
    <footer className="footer">
      <div className="footer-top">
        <div className="footer-column">
          <h3 style={{ color: "cyan" }}>About Us</h3>
          <ul>
            <li>
        ...
        <div className="footer-column">
          <h3 style={{ color: "cyan" }}>Customer Service</h3>
          <ul>
            <li>
              <a href="#">Contact Us</a>
            </li>
        ...
        <div className="footer-column">
          <h3 style={{ color: "cyan" }}>Follow Us</h3>
          <ul>
            <li>
              <a href="#">Facebook</a>
            </li>
            <li>
              <a href="https://www.instagram.com/rathifitnesss/">Instagram</a>
            </li>
            <li>
              <a href="#">Twitter</a>
            </li>
      ...
      <div className="footer-bottom">
        <p>© 2024 Rathi Fitnesss. All rights reserved.</p>
      </div>
    </footer>
  );
}
